...
void Mob::TempName(const char *newname)
{
	...
	entity_list.QueueClients(this, outapp);
	safe_delete(outapp);
	strn0cpy(playerbot_temp_name, temp_name, 64);
	EntityList::RemoveNumbers(playerbot_temp_name);
	SetName(temp_name);
}
...
void Mob::Say(const char *format, ...)
{
	...
	else if (npctype_id == RuleI(PlayerBots, PlayerBotId)) {
...
void Mob::SayString(Client *to, uint32 string_id, const char *message3, const char *message4, const char *message5, const char *message6, const char *message7, const char *message8, const char *message9)
{
	...
	// If playerbot, use the lua-generated playerbot
	if (npctype_id == RuleI(PlayerBots, PlayerBotId)) {
		to->MessageString(Chat::NPCQuestSay, GENERIC_STRINGID_SAY, playerbot_temp_name, string_id_str.c_str(), message3, message4, message5, message6, message7, message8, message9);
	}
	else
	{
...
void Mob::SayString(Client *to, uint32 type, uint32 string_id, const char *message3, const char *message4, const char *message5, const char *message6, const char *message7, const char *message8, const char *message9)
{
	...
	// If playerbot, use the lua-generated playerbot
	if (npctype_id == RuleI(PlayerBots, PlayerBotId)) {
		to->MessageString(type, GENERIC_STRINGID_SAY, playerbot_temp_name, string_id_str.c_str(), message3, message4, message5, message6, message7, message8, message9);
	}
	else
	{
