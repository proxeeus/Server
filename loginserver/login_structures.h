...
struct Login_ReplyBlock_Struct
{
	...
	unsigned char unknown3[4];	//0x00, 0x00, 0x00, 0x03
	unsigned char unknown4[4];	//0x00, 0x00, 0x00, 0x02
	unsigned char unknown5[4];	//0xe7, 0x03, 0x00, 0x00
	unsigned char unknown6[4];	//0xff, 0xff, 0xff, 0xff
	unsigned char unknown7[4];	//0xa0, 0x05, 0x00, 0x00
	unsigned char unknown8[4];	//0x00, 0x00, 0x00, 0x02
	unsigned char unknown9[4];	//0xff, 0x03, 0x00, 0x00
	unsigned char unknown10[4];	//0x00, 0x00, 0x00, 0x00
	unsigned char unknown11[4];	//0x63, 0x00, 0x00, 0x00
	unsigned char unknown12[4];	//0x01, 0x00, 0x00, 0x00
	unsigned char unknown13[4];	//0x00, 0x00, 0x00, 0x00
	unsigned char unknown14[4];	//0x00, 0x00, 0x00, 0x00
};
