...
public:
	...
	*/
	DatabasePostgreSQL(std::string user, string pass, std::string host, std::string port, std::string name);
	...
	*/
	virtual bool CreateWorldRegistration(string long_name, std::string short_name, unsigned int &id);
protected:
